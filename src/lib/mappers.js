 ...
 */
export function mapProjectCard(p, locale, toUrl) {
    return {
        id: p.id,
        slug: p.slug,
...
export function mapProjectDetail(p, locale, toUrl) {
...
export function mapTestimonial(t, locale, toUrl) {
...
export const PROJECT_CARD_COLUMNS = 'id, slug, title_th, title_en, description_th, description_en, role_th, role_en, ' +
