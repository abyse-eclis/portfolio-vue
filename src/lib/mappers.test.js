...
const toUrl = (p) => (p ? `https://cdn.test/${p}` : null);
...
describe('mapProjectDetail', () => {
    ...
    it('tolerates a non-array gallery', () => {
        const detail = mapProjectDetail({ id: 1, slug: 'x', title_en: 'X', description_en: 'd', type: 'web', gallery: null }, 'en', toUrl);
...
describe('mapTestimonial', () => {
    ...
    it('handles a missing project', () => {
        const t = mapTestimonial({ id: 6, client_name: 'Bob', content_en: 'ok', rating: 4 }, 'en', toUrl);
