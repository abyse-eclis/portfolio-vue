...
type IconName =
    ...
    | 'chevron-down' | 'chevron-right' | 'external-link' | 'check' | 'minus'
    | 'mail' | 'phone' | 'map-pin' | 'send' | 'loader'
    | 'github' | 'linkedin' | 'twitter' | 'facebook' | 'instagram' | 'youtube' | 'globe'
    | 'code' | 'code-bracket' | 'layers' | 'zap' | 'star' | 'briefcase' | 'user'
    | 'award' | 'clock' | 'server' | 'wrench' | 'palette' | 'database' | 'cube';
...
const path = computed(() => icons[props.name as IconName] ?? icons.code);
</script>
